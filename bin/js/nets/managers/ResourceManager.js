...
(function (managers) {
    ...
    var ResourceManager = /** @class */ (function () {
        ...
        ResourceManager.prototype.resLoaderComplete = function (msg) {
            ...
            /** 发布需要相关数据 */
            var releaseJson = ResLoader.getDataByFileName("release.json");
            ResourceManager.releaseDataArr = releaseJson["data"];
            /** 成就系统相关数据 */
            var achiveJson = ResLoader.getDataByFileName("talent.json");
            ResourceManager.achiveDataArr = achiveJson["data"];
            /** 成绩目标相关数据 */
            var achiveGoldJson = ResLoader.getDataByFileName("achiveGoal.json");
            ResourceManager.achiveGoldArr = achiveGoldJson["data"];
            /** 作家培养相关数据 */
            var trainJson = ResLoader.getDataByFileName("train.json");
            ResourceManager.trainArr = trainJson["data"];
            /** 新写作系统首页灵感选择数据 */
            var holeJson = ResLoader.getDataByFileName("writing.json");
            ResourceManager.holeArr = holeJson["data"];
            /** 触发事件相应数据 */
            var triggerJson = ResLoader.getDataByFileName("triggerEvent.json");
        ...
        ResourceManager.releaseDataArr = new Array();
        /** 存放解析后的talent.json对应的数据 */
        ResourceManager.achiveDataArr = new Array();
        /** 存放解析后的achiveGoal.json对应的数据 */
        ResourceManager.achiveGoldArr = new Array();
        /** 存放解析后的traint.json对应的数据 */
        ResourceManager.trainArr = new Array();
        /** 存放解析后的writing.json对应的数据 */
        ResourceManager.holeArr = new Array();
        /** 存放解析后的triggerEvent.json对应的数据 */
        ResourceManager.triggerArr = new Array();
