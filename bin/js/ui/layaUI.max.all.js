...
(function (ui) {
    ...
    (function (common) {
        var LoadingUI = /** @class */ (function (_super) {
            ...
            LoadingUI.uiView = { "type": "View", "props": { "width": 600, "height": 950 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 600, "skin": "gameUI/common/house.png", "height": 950 } }, { "type": "ProgressBar", "props": { "y": 834, "width": 265, "var": "progressBar", "value": 1, "skin": "comp/progress.png", "name": "progressBar", "height": 14, "centerX": 0 } }, { "type": "Label", "props": { "y": 870, "var": "progressTxt", "overflow": "visible", "name": "progressTxt", "fontSize": 18, "font": "Helvetica", "color": "#367390", "centerX": 0, "bold": false, "align": "center" } }, { "type": "Image", "props": { "y": 834, "x": 168, "width": 20, "var": "bar", "skin": "gameUI/AuthorData/green.png", "sizeGrid": "0,189,0,29", "name": "bar", "height": 14 } }] };
            return LoadingUI;
        }(View));
...
(function (ui) {
    ...
    (function (common) {
        var LoginViewUI = /** @class */ (function (_super) {
            ...
            LoginViewUI.uiView = { "type": "View", "props": { "width": 600, "height": 1200 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 600, "skin": "gameUI/common/bg.png", "height": 1200 } }, { "type": "Image", "props": { "y": 55, "x": 3, "width": 595, "skin": "gameUI/common/pic.png", "height": 550 } }, { "type": "Image", "props": { "y": 540, "width": 341, "skin": "gameUI/common/name.png", "height": 75, "centerX": 0 } }] };
            return LoginViewUI;
        }(View));
        common.LoginViewUI = LoginViewUI;
    })(common = ui.common || (ui.common = {}));
})(ui || (ui = {}));
(function (ui) {
    var common;
...
(function (ui) {
    var toolBar;
    (function (toolBar) {
        var LoginToolBarUI = /** @class */ (function (_super) {
            __extends(LoginToolBarUI, _super);
            function LoginToolBarUI() {
                return _super.call(this) || this;
            }
            LoginToolBarUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.toolBar.LoginToolBarUI.uiView);
            };
            LoginToolBarUI.uiView = { "type": "View", "props": { "width": 254, "height": 165 }, "child": [{ "type": "Button", "props": { "width": 254, "var": "phoneLogin", "stateNum": 2, "skin": "gameUI/common/buttonA.png", "name": "phoneLogin", "labelSize": 30, "labelFont": "SimSun", "labelColors": "#FFFFFF", "labelBold": true, "labelAlign": "center", "label": "手机登录", "height": 75, "centerX": 0 } }, { "type": "Button", "props": { "y": 90, "width": 254, "var": "fastGame", "stateNum": 2, "skin": "gameUI/common/buttonA.png", "name": "fastGame", "labelSize": 30, "labelFont": "SimSun", "labelColors": "#FFFFFF", "labelBold": true, "labelAlign": "center", "label": "快速游戏", "height": 75, "centerX": 0 } }] };
            return LoginToolBarUI;
        }(View));
        toolBar.LoginToolBarUI = LoginToolBarUI;
    })(toolBar = ui.toolBar || (ui.toolBar = {}));
})(ui || (ui = {}));
(function (ui) {
    var toolBar;
    (function (toolBar) {
        var PhoneLoginUI = /** @class */ (function (_super) {
            __extends(PhoneLoginUI, _super);
            function PhoneLoginUI() {
                return _super.call(this) || this;
            }
            PhoneLoginUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.toolBar.PhoneLoginUI.uiView);
            };
            PhoneLoginUI.uiView = { "type": "View", "props": { "width": 254, "height": 140 }, "child": [{ "type": "TextInput", "props": { "width": 254, "var": "phoneNum", "skin": "gameUI/common/inputB.png", "promptColor": "#ffffff", "prompt": "请输入手机号", "name": "phoneNum", "height": 40, "fontSize": 18, "font": "SimSun", "color": "#ffffff", "bold": true, "align": "center" } }, { "type": "TextInput", "props": { "y": 49, "width": 122, "var": "code", "skin": "gameUI/common/inputB.png", "promptColor": "#ffffff", "prompt": "验证码", "name": "code", "height": 40, "fontSize": 25, "font": "SimSun", "color": "#ffffff", "bold": true, "align": "center" } }, { "type": "Button", "props": { "y": 49, "x": 133, "width": 122, "var": "sendCode", "stateNum": 2, "skin": "gameUI/common/buttonA.png", "sizeGrid": "5,5,5,5", "name": "sendCode", "labelFont": "SimSun", "labelColors": "#ffffff", "labelBold": true, "labelAlign": "center", "label": "获取验证码", "height": 40 } }, { "type": "Button", "props": { "y": 97, "width": 254, "var": "startGameBtn", "stateNum": 2, "skin": "gameUI/common/buttonA.png", "sizeGrid": "5,5,5,5,", "name": "startGameBtn", "labelSize": 18, "labelFont": "SimSun", "labelColors": "#ffffff", "labelBold": true, "labelAlign": "center", "label": "进入游戏", "height": 40, "centerX": 0 } }] };
            return PhoneLoginUI;
        }(View));
        toolBar.PhoneLoginUI = PhoneLoginUI;
    })(toolBar = ui.toolBar || (ui.toolBar = {}));
})(ui || (ui = {}));
(function (ui) {
    var toolBar;
    (function (toolBar) {
        var TopToolBarUI = /** @class */ (function (_super) {
            __extends(TopToolBarUI, _super);
            function TopToolBarUI() {
                return _super.call(this) || this;
            }
            TopToolBarUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.toolBar.TopToolBarUI.uiView);
            };
            TopToolBarUI.uiView = { "type": "View", "props": { "width": 600, "height": 46 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 600, "var": "bg", "skin": "gameUI/common/batten.png", "name": "bg", "height": 46 } }, { "type": "Image", "props": { "y": 0, "x": 0, "skin": "gameUI/toolbar/money.png" } }, { "type": "Label", "props": { "y": 12, "x": 69, "var": "money", "valign": "middle", "name": "money", "fontSize": 25, "font": "SimHei", "color": "#000000", "bold": true } }, { "type": "Image", "props": { "y": 0, "x": 220, "skin": "gameUI/toolbar/idea.png" } }, { "type": "Label", "props": { "y": 12, "x": 260, "var": "brainHole", "name": "brainHole", "fontSize": 25, "font": "SimHei", "color": "#000000", "bold": true } }, { "type": "Image", "props": { "y": 4, "x": 417, "skin": "gameUI/toolbar/fans.png" } }, { "type": "Label", "props": { "y": 12, "x": 480, "var": "fans", "name": "fans", "fontSize": 25, "font": "SimHei", "color": "#000000", "bold": true } }] };
            return TopToolBarUI;
        }(View));
        toolBar.TopToolBarUI = TopToolBarUI;
    })(toolBar = ui.toolBar || (ui.toolBar = {}));
})(ui || (ui = {}));
