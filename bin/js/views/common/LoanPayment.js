    ...
    (function (common) {
        ...
        var LoanPayment = /** @class */ (function (_super) {
            ...
            function LoanPayment(money, loan) {
                ...
                _this.nianxin.visible = true;
                _this.daikuan.visible = true;
                _this.wenbentittle.text = '您今天一共需要支付：';
                _this.nianxin.text = '年薪： ';
                _this.daikuan.text = '贷款： ';
                _this.daikuan.visible = true;
                _this.tipInfoBox.text = money.toString();
                _this.tipInfoBox2.text = loan.toString();
                _this.tittle.text = '支出';
